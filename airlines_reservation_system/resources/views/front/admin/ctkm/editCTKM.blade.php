...
@section('title', 'UPDATE-ChuongTrinhKhuyenMai')
                            ...
                            <div class="row">
                                ...
                                <form action="" method="post" enctype="multipart/form-data" style="margin-left: 280px;">
                                    ...
                                    <div class="form-group" style="width: 500px">
                                        ...
                                        <input type="text" name="tieude" class="form-control" value="{{$KM->tieude}}">
                                        <span class="help-block"></span>
                                    </div>
                                    <div class="form-group ">
                                        <label style="font-size: 15px">Lời Dẫn</label>
                                        <input style="white-space: break-spaces;height: 100px" type="text" name="loidan" class="form-control" value="{{$KM->loidan}}">
                                        <span class="help-block"></span>
                                    </div>

                                    <div class="form-group">
                                        <label style="font-size: 15px">Nội Dung</label>
                                            <input name="noidung" style="white-space: break-spaces;height: 200px" class="form-control" value="{{$KM->noidung}}">
                                    </div>
                                    <div class="form-group">
                                        <label style="font-size: 15px">Ảnh</label>
                                        <input type="file" name="anh" class="form-control" value="{{$KM->anh}}">
                                        <span class="help-block"></span>
                                    </div>
