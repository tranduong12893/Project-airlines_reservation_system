                                ...
                                <div class="nhap" >
                                    <form action="" method="post" enctype="multipart/form-data" style="margin-left: 280px">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="mave" class="form-control" value="{{$Ve->mave}}">
                                            <span class="help-block"></span>
                                        </div>
                                        <div class="form-group ">
                                            <label style="font-size: 15px">Mã Thành Viên</label>
                                            <input type="text" name="mathanhvien" class="form-control" value="{{$Ve->mathanhvien}}">
                                            <span class="help-block"></span>
                                        </div>
                                        <div class="form-group">
                                            <label style="font-size: 15px">Mã Chuyến Bay</label>
                                            <input type="text" name="machuyenbay" class="form-control" value="{{$Ve->machuyenbay}}">
                                        </div>
                                        <div class="form-group">
                                            <label style="font-size: 15px">Mã Loại Vé</label>
                                            <input type="text" name="maloaive" class="form-control" value="{{$Ve->maloaive}}">
                                            <span class="help-block"></span>
                                        </div>
                                        <div class="form-group">
                                            <label style="font-size: 15px">Mã Dịch Vụ</label>
                                            <input type="text" name="madichvu" class="form-control" value="{{$Ve->madichvu}}">
                                            <span class="help-block"></span>
                                        </div>
