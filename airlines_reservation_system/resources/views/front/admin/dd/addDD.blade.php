                        ...
                        <div class="container_fluid">
                            <div class="row">
                                <div class="page-header"style="margin-left: 8px; width: 100%; text-align: center">
                                    <h2>Thêm Mới Điểm Đến Yêu Thích </h2>
                                </div>
                                <div class="nhap">
                                    <form action="" method="post" enctype="multipart/form-data" style="margin-left: 280px;">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <textarea rows="10" cols="100"   type="text" name="loidan" class="form-control" style="white-space: break-spaces;"></textarea>
                                            <span class="help-block"></span>
                                        </div>
                                        <div class="form-group">
